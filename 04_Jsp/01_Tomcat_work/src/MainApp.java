...
public class MainApp {
    ...
    public void method03(){
         ...
         */
        StudentDao dao = new StudentDaoImpl();
        Student 猫羽雫 = new Student(null, "猫羽雫", "maoyuna@twiter.com", 16,  new Date());
        Student 美美 = new Student(null, "美美", "meimei@princessConnector.com", 12,  new Date());
    ...
    public void method05(){
         ...
         */
        StudentDao dao = new StudentDaoImpl();
        Student student = new Student(2, "镜华", "jinghua@princess.com", 13, new Date());
