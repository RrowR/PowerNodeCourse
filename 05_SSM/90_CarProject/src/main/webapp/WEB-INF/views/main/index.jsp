...
<head>
    ...
    <link rel="icon" href="${ctx}/resources/layuimini/images/favicon.ico">
    <link rel="stylesheet" href="${ctx}/resources/layuimini/lib/layui-v2.6.3/css/layui.css" media="all">
    <link rel="stylesheet" href="${ctx}/resources/layuimini/css/layuimini.css?v=2.0.4.2" media="all">
    <link rel="stylesheet" href="${ctx}/resources/layuimini/css/themes/default.css" media="all">
